...
function media_upload_type_url_form( $type = null, $errors = null, $id = null ) {
	...
	<?php
	$csp_no_img  = esc_url( admin_url( 'images/no.png' ) );
	$csp_yes_img = esc_url( admin_url( 'images/yes.png' ) );
	$csp_spinner = esc_url( admin_url( 'images/spinner-2x.gif' ) );

	$add_ext_image_js  = "	var addExtImage = {
...
";
	...
	resetImageData : function() {
		...
		else document.getElementById('status_img').innerHTML = '<img src=\"@@NO@@\" alt=\"\" />';
	},
	...
	updateImageData : function() {
		...
		document.getElementById('status_img').innerHTML = '<img src=\"@@YES@@\" alt=\"\" />';
	},
	...
	getImageData : function() {
		...
		document.getElementById('status_img').innerHTML = '<img src=\"@@SPIN@@\" alt=\"\" width=\"16\" height=\"16\" />';
	...
	wp_print_inline_script_tag( $add_ext_image_js );
	?>ia-items">
